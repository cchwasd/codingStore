...
/* @@protoc_insertion_point(class_definition:example.LoginResponse) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "example.LoginResponse"; }
...
class LoginRequest final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:example.LoginRequest) */ {
 public:
 ...
 private:
  ...
  friend ::absl::string_view(
      ::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "example.LoginRequest"; }
...
inline const std::string& LoginResponse::message() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:example.LoginResponse.message)
...
inline PROTOBUF_ALWAYS_INLINE void LoginResponse::set_message(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:example.LoginResponse.message)
}
inline std::string* LoginResponse::mutable_message() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:example.LoginResponse.message)
  return _s;
}
...
inline std::string* LoginResponse::release_message() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:example.LoginResponse.message)
...
inline void LoginResponse::set_allocated_message(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:example.LoginResponse.message)
}
