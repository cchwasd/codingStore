...
const ::uint32_t
    TableStruct_account_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::example::LoginRequest, _impl_.username_),
        PROTOBUF_FIELD_OFFSET(::example::LoginRequest, _impl_.password_),
        ~0u,  // no _has_bits_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::example::LoginResponse, _impl_.message_),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ...
        {10, -1, -1, sizeof(::example::LoginResponse)},
};
...
const char descriptor_table_protodef_account_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\raccount.proto\022\007example\"2\n\014LoginRequest"
    "\022\020\n\010username\030\001 \001(\t\022\020\n\010password\030\002 \001(\t\"1\n\r"
    "LoginResponse\022\017\n\007message\030\001 \001(\t\022\017\n\007succes"
    "s\030\002 \001(\0102F\n\014LoginService\0226\n\005Login\022\025.examp"
    "le.LoginRequest\032\026.example.LoginResponseb"
    "\006proto3"
};
...
inline PROTOBUF_NDEBUG_INLINE LoginRequest::Impl_::Impl_(
    ...
    const Impl_& from, const ::example::LoginRequest& from_msg)
...
const ::_pbi::TcParseTable<1, 2, 0, 45, 2> LoginRequest::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::example::LoginRequest>(),  // to_prefetch
        ...
        ::uint8_t* LoginRequest::_InternalSerialize(
          ...
          if (!this_._internal_username().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "example.LoginRequest.username");
          ...
          if (!this_._internal_password().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "example.LoginRequest.password");
...
inline PROTOBUF_NDEBUG_INLINE LoginResponse::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::example::LoginResponse& from_msg)
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<1, 2, 0, 37, 2> LoginResponse::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    2, 8,  // max_field_number, fast_idx_mask
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::example::LoginResponse>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // bool success = 2;
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* LoginResponse::_InternalSerialize(
          ...
          if (!this_._internal_message().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "example.LoginResponse.message");
            target = stream->WriteStringMaybeAliased(1, _s, target);
          }
